...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        (function (decompiler) {
            ...
            function checkStatement(node, env, asExpression, topLevel) {
                ...
                function checkVariableDeclaration(n, env) {
                    if (n.name.kind !== SK.Identifier) {
                        return pxtc.Util.lf("Variable declarations may not use binding patterns");
                    }
                    if (!n.initializer) {
                        return pxtc.Util.lf("Variable declarations must have an initializer");
                    }
                    if (isAutoDeclaration(n, env)) {
                        return undefined;
                    }
                    if (n.type && !isBlocklyType(n.type)) {
                        return pxtc.Util.lf("Variable type is not supported by Blockly");
                    }
            ...
            function isAutoDeclaration(decl, env) {
                if (decl.initializer) {
                    if (isTopLevelNode(decl) && env.opts.generatedVarDeclarations) {
                        var varInfo = env.opts.generatedVarDeclarations[decl.name.getText()];
            ...
            function isBlocklyType(n) {
                switch (n.kind) {
                    ...
                    case SK.StringKeyword:
                        return true;
                    case SK.ArrayType:
                        return isBlocklyType(n.elementType);
                    default:
                        return false;
                }
            }
...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        function decompile(program, opts, fileName, includeGreyBlockMessages, generatedVarDeclarations) {
        ...
        (function (service_1) {
            ...
            var operations = {
                ...
                decompile: function (v) {
                    host.setOpts(v.options);
                    return pxtc.decompile(service.getProgram(), v.options, v.fileName, false, v.generatedVarDeclarations);
                },
